...
exports.shouldExclude = (t) => {
    return (t.options !== undefined &&
...
exports.shouldExcludeFile = (fileName) => {
    // read file
    const b = fs_extra_1.default.readFileSync(fileName, { encoding: 'utf-8' });
    // look for // @bento-exclude, optionally without leading space
    return b.match(/^\/\/ ?@bento-exclude/gm) !== null;
};
exports.processFile = (fileName) => __awaiter(this, void 0, void 0, function* () {
    if (fileName.includes('node_modules')) {
        return false;
    }
    // has exclusion?
    if (exports.shouldExcludeFile(fileName)) {
...
exports.run = (globPaths) => __awaiter(this, void 0, void 0, function* () {
    ...
    for (const file of files) {
        yield exports.processFile(file);
    }
});
