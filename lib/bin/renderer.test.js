...
describe('Renderer', () => {
    ...
    it('skips a file based on @bento-exclude comment', () => {
        const file = path_1.default.relative(process.cwd(), path_1.default.join(__dirname, '../test/fixtures/norender.proto'));
        expect(renderer_1.shouldExcludeFile(file)).toBe(true);
    });
});
